...
public class URLImageGetter implements Html.ImageGetter {
    ...
    private static final String mFilePath = ForFunApp.getAppContext().getCacheDir().getAbsolutePath();
    public Subscription mSubscription;
    private String TAG="URLImageGetter";
...
//        Log.e(TAG,"图片的source"+source);
    ...
    private Drawable createPicPlaceholder() {
        ...
        drawable = new ColorDrawable(ForFunApp.getAppContext().getResources().getColor(color));
