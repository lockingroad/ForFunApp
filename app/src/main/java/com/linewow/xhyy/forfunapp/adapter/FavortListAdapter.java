...
import com.linewow.xhyy.forfunapp.spannable.CircleMovementMethod;
import com.linewow.xhyy.forfunapp.spannable.NameClickable;
...
public class FavortListAdapter {
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(ForFunApp.getAppContext(), R.mipmap.dianzansmal, DynamicDrawableSpan.ALIGN_BASELINE),
