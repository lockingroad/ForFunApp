...
/*
   1. noCache 不使用缓存，全部走网络
    ...
    private Api(int hostType) {
        ...
        //缓存
        File cacheFile = new File(ForFunApp.getAppContext().getCacheDir(), "cache");
    ...
    public static String getCacheControl() {
        return NetWorkUtils.isNetConnected(ForFunApp.getAppContext()) ? CACHE_CONTROL_AGE : CACHE_CONTROL_CACHE;
    }
    ...
    private final Interceptor mRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetWorkUtils.isNetConnected(ForFunApp.getAppContext())) {
