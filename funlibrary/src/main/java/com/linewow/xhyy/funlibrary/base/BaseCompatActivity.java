...
public abstract class BaseCompatActivity<P extends BasePresenter,M extends BaseModel> extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context=this;
        presenter= TUtil.getT(BaseCompatActivity.this,0);
        model=TUtil.getT(BaseCompatActivity.this,1);
        if(presenter!=null){
    ...
    public void startActivity(Class<?> cls, Bundle bundle) {
        ...
        intent.setClass(BaseCompatActivity.this, cls);
        if (bundle != null) {
    ...
    public void startActivityShare(Class<?>cls,View...view) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            final Pair<View, String>[] pairs = TransitionHelper.createSafeTransitionParticipants(BaseCompatActivity.this, false, (Pair[]) pairList.toArray());
